...
/// Test printing of IP defined by a single char.
///
...
/// Test printing of IP defined by a word (2 chars).
///
...
/// Test printing of IP defined by a double word (4 chars).
///
...
/// Test printing of IP defined by a quad word (8 chars).
///
...
/// Test printing of IP defined by a string.
///
...
/// Test printing of IP defined by a vector.
///
...
/// Test printing of IP defined by a list.
///
...
/// Test printing of IP defined by a tuple.
///
...
/// Test printing of IP defined by a tuple with arguments of different types.
/// Different types should produce a compilation error, so this test should be commented out to allow project to be
/// compiled. If you want to check if the requirement of the same types still works, just uncomment this test and try to
/// build the project.
